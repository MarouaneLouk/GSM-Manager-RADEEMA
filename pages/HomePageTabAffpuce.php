...
<div class="table-container">
    <h2 style="margin-left: 6px;">Affectation de puces</h2>
    <div class="table-header">
        <div class="firstdiv">
                        ...
                        <form id="filter-form">
                            <div class="form-group">
                                ...
                                <select id="order-by" name="order-by">
                                    ...
                                    <option value="5">Etat</option>
                                    <option value="6">Type Puces</option>
                                    <option value="7">Date Affectation</option>
                                    <option value="8">Date Désaffectation</option>
                                    <option value="9">Entité</option>
                                </select>
                            </div>
                            <div class="form-group">
            ...
            <div class="search-div" style="display: inline;">
                <input class="searchbar" type="text" id="searchTable" placeholder="Search Affected Puces By Code, ...">
    ...
    <div id="popUps">
        ...
        <div id="createPopup" class="popup">
            <div class="popup-content">
                ...
                <h2>Create Affectation</h2>
                <form action="../php/createAffpuce.php" method="POST">
                    <?php
                    ...
                    <?php
                        ...
                        $selectMatricule = $selectMatricule->GetSelectMatricule();
                    ?>
                    <?php
                        $selectPersona = new UsersView();
                        $selectPersona = $selectPersona->GetSelectPersona();
                    ?>
                    <label for="dateAffectation"><span style="color:red">*</span>Date Affectation:</label>
                    <input class="addWeight" type="date" id="dateAffectation" name="dateAffectation" required>
                    <label for="dateDesaffectation"><span style="color:red">*</span>Date Désaffectation:</label>
                    <input class="addWeight" type="date" id="dateDesaffectation" name="dateDesaffectation" required>
    ...
    <?php
        if (isset($_SESSION['crAffpuceError'])) {
            echo '<div id="message-container" class="hidden">';
            echo '<p id="message-text">' . $_SESSION['crAffpuceError'] . '</p>';
            echo '</div>';
            unset($_SESSION['crAffpuceError']);
        }
        ...
        if (isset($_SESSION['deleteAffpuceError'])) {
            echo '<div id="message-container" class="hidden">';
            echo '<p id="message-text">' . $_SESSION['deleteAffpuceError'] . '</p>';
            echo '</div>';
            unset($_SESSION['deleteAffpuceError']);
        }
        if (isset($_SESSION['modifyAffpuceError'])) {
            echo '<div id="message-container" class="hidden">';
            echo '<p id="message-text">' . $_SESSION['modifyAffpuceError'] . '</p>';
            echo '</div>';
            unset($_SESSION['modifyAffpuceError']);
        }
    ?>
    </div>
    <div class="table">
    <form id="modifyForm" action="../php/deleteModifyAffpuce.php" method="POST">
        <table id="example-table">
            ...
            <thead>
                <tr>
                    ...
                    <th onclick="sortTableHeader(1)">Matricule<span id="arrow1" class="inactive-arrow"></span></th>
                    <th onclick="sortTableHeader(2)">Nom<span id="arrow2" class="inactive-arrow"></span></th>
                    <th onclick="sortTableHeader(3)">Prenom<span id="arrow3" class="inactive-arrow"></span></th>
                    <th onclick="sortTableHeader(4)">Puce<span id="arrow4" class="inactive-arrow"></span></th>
                    <th onclick="sortTableHeader(5)">Etat<span id="arrow5" class="inactive-arrow"></span></th>
                    <th onclick="sortTableHeader(6)">Type Puces<span id="arrow6" class="inactive-arrow"></span></th>
                    <th onclick="sortTableHeader(7)">Date Affectation<span id="arrow7" class="inactive-arrow"></span></th>
                    <th onclick="sortTableHeader(8)">Date Désaffectation<span id="arrow8" class="inactive-arrow"></span></th>
                    <th onclick="sortTableHeader(9)">Entité<span id="arrow9" class="inactive-arrow"></span></th>
                    <th>View More</th>
                </tr>
            </thead>
            <tbody>
                <?php
                    ...
                    $nbrowtab = $userTable->showAffpuceTable();
                ?>
            </tbody>
        </table>
    </form>
