...
<nav class="nav container">
    <div style="display: flex;gap:10px;white-space: nowrap;">
        <a href="../html/HomePage.php" class="nav__logo"><img class="logoImage" src="../images/logoRADEEMA.svg" width="45"></a>
...
<div class="table-container">
    <h2 style="margin-left: 6px;">Gestion Entité</h2>
    <div class="table-header">
        <div class="firstdiv">
            <button class="filterButton filter-btn buttonDiff">
                <svg style="float:left;margin-right:3px" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 21 21" fill="none">
                    ...
                    <path d="M12.0109 12.931L20.0129 4.92899V0.927979H0.00787354V4.92899L8.0099 12.931V20.933L12.0109 16.932V12.931Z"/>
                    </g>
                    <defs>
            ...
            <div id="filterPopup" class="popup-overlay">
                <div class="popup-content">
                    ...
                    <div class="popup-body">
                        <form action="filter.php" id="filter-form">
                            <div class="form-group">
                                ...
                                <select id="order-by" name="order-by">
                                    ...
                                    <option value="3">Entité Mère</option>
                                </select>
                            </div>
                            <div class="form-group">
            ...
            <div class="search-div" style="display: inline;">
                <input class="searchbar" type="text" id="searchTable" placeholder="Search Entity by Name, Type, ...">
        ...
        <div id="popUps">
            ...
            <div id="createPopup" class="popup">
                <div class="popup-content">
                    ...
                    <h2>Create Entité</h2>
                    <form action="../php/createEntite.php" method="POST">
                        ...
                        <?php
                            ...
                            $selectEntiteMere = $selectEntiteMere->GetSelectEntiteMere();
                        ?>
        ...
        <?php
            if(isset($_SESSION["crEntiteError"])){
                echo '<div id="message-container" class="hidden">';
                echo '<p id="message-text">' . $_SESSION["crEntiteError"] . '</p>';
                echo '</div>';
                unset($_SESSION['crEntiteError']);
            }
            ...
            if (isset($_SESSION['deleteEntiteError'])) {
                echo '<div id="message-container" class="hidden">';
                echo '<p id="message-text">' . $_SESSION['deleteEntiteError'] . '</p>';
                echo '</div>';
                unset($_SESSION['deleteEntiteError']);
            }
            if (isset($_SESSION['modifyEntiteError'])) {
                echo '<div id="message-container" class="hidden">';
                echo '<p id="message-text">' . $_SESSION['modifyEntiteError'] . '</p>';
                echo '</div>';
                unset($_SESSION['modifyEntiteError']);
            }
        ?>
    </div>
    <div class="table">
        <form id="modifyForm" action="../php/deleteModifyEntite.php" method="POST">
            <table id="example-table">
                ...
                <thead>
                    <tr>
                        ...
                        <th onclick="sortTableHeader(3)">Entité Mère<span id="arrow3" class="inactive-arrow"></span></th>
                        <th>View More</th>
                    </tr>
                </thead>
                <tbody> 
                    <?php
                        ...
                        $nbrowtab = $userTable->showEntiteTable();
                    ?>
                </tbody>
            </table>
        </form>
