...
<div class="table-container">
    <h2 style="margin-left: 6px;">Gestion de personnes</h2>
    <div class="table-header">
        <div class="firstdiv">
            ...
            <div class="search-div" style="display: inline;">
                <input class="searchbar" type="text" id="searchTable" placeholder="Search People by Matricule, Nom, ...">
    ...
    <div id="popUps">
        ...
        <div id="createPopup" class="popup">
            <div class="popup-content">
                ...
                <form action="../php/createPersonnel.php" method="POST">
                    <label for="matricule"><span style="color:red">*</span>Matricule:</label>
                    <input class="addWeight" type="text" id="matricule" name="matricule" maxlength="5" required>
                    ...
                    <input class="addWeight" type="text" id="nom" name="nom" required>
                    <label for="prenom"><span style="color:red">*</span>Prenom:</label>
                    <input class="addWeight" type="text" id="prenom" name="prenom" required>
                    <?php
                        $selectEntite = new UsersView();
                        $selectEntite = $selectEntite->GetSelectEntite();
                    ?>
    ...
    <?php
        if(isset($_SESSION["crPerError"])){
            echo '<div id="message-container" class="hidden">';
            echo '<p id="message-text">' . $_SESSION["crPerError"] . '</p>';
            echo '</div>';
            unset($_SESSION['crPerError']);
        }
        ...
        if (isset($_SESSION['deletePersError'])) {
            echo '<div id="message-container" class="hidden">';
            echo '<p id="message-text">' . $_SESSION['deletePersError'] . '</p>';
            echo '</div>';
            unset($_SESSION['deletePersError']);
        }
        if (isset($_SESSION['modifyPersError'])) {
            echo '<div id="message-container" class="hidden">';
            echo '<p id="message-text">' . $_SESSION['modifyPersError'] . '</p>';
            echo '</div>';
            unset($_SESSION['modifyPersError']);
        }
    ?>
    </div>
    <div class="table">
    <form id="modifyForm" action="../php/deleteModifyPersonnel.php" method="POST">
        <table id="example-table">
            ...
            <thead>
                <tr>
                    ...
                    <th onclick="sortTableHeader(2)">User Status<span id="arrow2" class="inactive-arrow"></span></th>
                    <th onclick="sortTableHeader(3)">Nom<span id="arrow3" class="inactive-arrow"></span></th>
                    <th onclick="sortTableHeader(4)">Prenom<span id="arrow4" class="inactive-arrow"></span></th>
                    <th onclick="sortTableHeader(5)">Entité<span id="arrow5" class="inactive-arrow"></span></th>
                    <th onclick="sortTableHeader(6)">Observation<span id="arrow6" class="inactive-arrow"></span></th>
                    <th>View More</th>
                </tr>
            </thead>
            <tbody>
                <?php
                    ...
                    $nbrowtab = $userTable->showPersonnelTable();
                ?>
            </tbody>
        </table>
    </form>
