...
<div class="table-container">
    <h2 style="margin-left: 6px;">Gestion de puces</h2>
    <div class="table-header">
        <div class="firstdiv">
                        ...
                        <form id="filter-form">
                            <div class="form-group">
                                ...
                                <select id="order-by" name="order-by">
                                    ...
                                    <option value="3">Type Puce</option>
            ...
            <div class="search-div" style="display: inline;">
                <input class="searchbar" type="text" id="searchTable" placeholder="Search Puces by Numero, Code, ...">
    ...
    <div id="popUps">
        ...
        <div id="createPopup" class="popup">
            <div class="popup-content">
                ...
                <h2>Create Puce</h2>
                <form action="../php/createPuce.php" method="POST">
                    <label for="numero"><span style="color:red">*</span>Numero:</label>
                    <input class="addWeight" type="tel" id="numero" name="numero" maxlength="10" required>
                    <label for="code"><span style="color:red">*</span>Code:</label>
                    <input class="addWeight" type="text" id="code" name="code" maxlength="5" required>
    ...
    <?php
        if(isset($_SESSION["crPuceError"])){
            echo '<div id="message-container" class="hidden">';
            echo '<p id="message-text">' . $_SESSION["crPuceError"] . '</p>';
            echo '</div>';
            unset($_SESSION['crPuceError']);
        }
        ...
        if (isset($_SESSION['deletePuceError'])) {
            echo '<div id="message-container" class="hidden">';
            echo '<p id="message-text">' . $_SESSION['deletePuceError'] . '</p>';
            echo '</div>';
            unset($_SESSION['deletePuceError']);
        }
        if (isset($_SESSION['modifyPuceError'])) {
            echo '<div id="message-container" class="hidden">';
            echo '<p id="message-text">' . $_SESSION['modifyPuceError'] . '</p>';
            echo '</div>';
            unset($_SESSION['modifyPuceError']);
        }
    ?>
    </div>
    <div class="table">
    <form id="modifyForm" action="../php/deleteModifyPuce.php" method="POST">
        <table id="example-table">
            ...
            <thead>
                <tr>
                    ...
                    <th onclick="sortTableHeader(1)">Numero<span id="arrow1" class="inactive-arrow"></span></th>
                    <th onclick="sortTableHeader(2)">Code<span id="arrow2" class="inactive-arrow"></span></th>
                    <th onclick="sortTableHeader(3)">Type Puce<span id="arrow3" class="inactive-arrow"></span></th>
                    <th onclick="sortTableHeader(4)">Etat<span id="arrow4" class="inactive-arrow"></span></th>
            ...
            <tbody>
                <?php
                    ...
                    $nbrowtab = $userTable->showPuceTable();
                ?>
            </tbody>
        </table>
    </form>
