...
<div class="table-container">
    <h2 style="margin-left: 6px;">Reporting</h2>
    <div class="table-header">
        <div class="firstdiv">
                        ...
                        <form id="filter-form">
                            <div class="form-group">
                                ...
                                <select id="order-by" name="order-by">
                                    <option></option>
                                    <option value="1">Nom Entité</option>
                                    <option value="2">Type Entité</option>
                                    <option value="3">Nombre de puces voix</option>
                                    <option value="4">Nombre  de puces data</option>
                                    <option value="5">Entité Mère</option>
                                </select>
                            </div>
                            <div class="form-group">
            ...
            <div class="search-div" style="display: inline;">
                <input class="searchbar" type="text" id="searchTable" placeholder="Search Reportings by Name, Type, ...">
    ...
    <div id="popUps">
        ...
        <div id="createPopup" class="popup">
            <div class="popup-content">
                ...
                <h2>Create Reporting</h2>
                <form>
                    <label for="nomEntite"><span style="color:red">*</span>Nom Entité:</label>
                    <input class="addWeight" type="text" id="nomEntite" name="nomEntite" required>
                    <label for="typeEntite"><span style="color:red">*</span>Type Entité:</label>
                    <input class="addWeight" type="text" id="typeEntite" name="typeEntite" required>
                    <label for="nombrePuceVoix"><span style="color:red">*</span>Nombre de puces voix:</label>
                    <input class="addWeight" type="number" id="nombrePuceVoix" name="nombrePuceVoix" required min="0">
                    <label for="nombrePuceData"><span style="color:red">*</span>Nombre de puces data:</label>
                    <input class="addWeight" type="number" id="nombrePuceData" name="nombrePuceData" required min="0">
                    <label for="entiteMere"><span style="color:red">*</span>Entité Mère:</label>
                    <input class="addWeight" type="text" id="entiteMere" name="entiteMere" required>
        ...
        <div id="modifyPopup" class="popup">
            <div class="popup-content">
                <span class="close" onclick="closePopup('modifyPopup')">
                    <svg width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#000000" stroke-width="0.00024000000000000003">
    ...
    <table id="example-table">
        <thead>
            <tr>
                ...
                <th onclick="sortTableHeader(1)">Nom Entité<span id="arrow1" class="inactive-arrow"></span></th>
                <th onclick="sortTableHeader(2)">Type Entité<span id="arrow2" class="inactive-arrow"></span></th>
                <th onclick="sortTableHeader(3)">Nombre de puces voix<span id="arrow3" class="inactive-arrow"></span></th>
                <th onclick="sortTableHeader(4)">Nombre de puces data<span id="arrow4" class="inactive-arrow"></span></th>
                <th onclick="sortTableHeader(5)">Entité Mère<span id="arrow5" class="inactive-arrow"></span></th>
                <th>View More</th>
            </tr>
        </thead>
        <tbody>
            <?php
                $reportTable = new UsersView();
                $nbrowreportTable = $reportTable->showReportTable();
            ?>
        </tbody>
    </table>
